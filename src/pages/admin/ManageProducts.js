        ...
        <table className="min-w-full border">
          <thead className="bg-gray-100">
            <tr className="text-[16px]">
              ...
              <th className="font-semibold p-3">Sold</th>
              <th className="font-semibold p-3">Ratings</th>
            ...
            {products &&
              products.map((product, index) => (
                <tr key={product._id}>
                  ...
                  <td className="p-3">
                    <p title={`$${(product.price * 0.000043).toFixed(2)}USD`}>
                      {product.price.toLocaleString("vi-VN") + " VND"}
                    </p>
                  </td>
                  <td className="p-3">{product.quantity}</td>
                  <td className="p-3">{product.sold}</td>
                  <td className="p-3">{product.totalRating}</td>
                  <td className="p-3">
